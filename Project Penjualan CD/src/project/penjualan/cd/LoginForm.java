...
public class LoginForm extends javax.swing.JFrame {
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(JPasswordField, javax.swing.GroupLayout.DEFAULT_SIZE, 116, Short.MAX_VALUE)))
                .addGap(44, 44, 44))
        );
    ...
    private void JLoginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JLoginButtonActionPerformed
         try{
            ...
            ResultSet result = stat.executeQuery("SELECT * FROM `tb_user` WHERE " + "Username='"+ JUsernameField.getText()+"'");
            if (result.next()){
                if(JPasswordField.getText().equals(result.getString("Password"))){
